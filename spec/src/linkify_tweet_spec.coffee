...
describe "linkifyTweet", ->
  it "should linkify URL", ->
    expect(linkifyTweet(tweet1)).toEqual "<a href='http://twitter.com/search?q=%23foo'>#foo</a> <a href='http://twitter.com/bar'>@bar</a> <a href='http://t.co/PI9t2u5'>http://t.co/PI9t2u5</a>"